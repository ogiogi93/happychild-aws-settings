...

{
  ...
  app: {
    ...
    env: {
        ...
        MYSQL_DATABASE: 'holiday-visualization',
        MYSQL_PASSWORD: provideFromFile('mysql_password'),
        MYSQL_visualizer_USER: 'root',
        MYSQL_visualizer_HOST: 'holiday-visualizer-staging-001.cnghgma2cgdu.ap-northeast-1.rds.amazonaws.com',
        MYSQL_VISUALIXATION_DATABASE: 'holiday-visualizer',
        MYSQL_VISUALIXATION_PASSWORD: provideFromFile('mysql_password'),
